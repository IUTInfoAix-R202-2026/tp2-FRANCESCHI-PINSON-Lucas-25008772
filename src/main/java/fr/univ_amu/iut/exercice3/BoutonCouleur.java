...
public class BoutonCouleur extends Button {
  ...
  //
  // 1. Déclarer si nécessaire, un champ IntegerProperty nbClics
  // (SimpleIntegerProperty, valeur 0).
  //
  // 2. Déclarer si nécessaire, un champ String couleur (la couleur CSS du bouton,
  // ex: "red").
  //
